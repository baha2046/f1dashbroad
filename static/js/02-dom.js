...
const DOM = {
    ...
    telemetryInputsWrapper: document.getElementById('telemetryInputsWrapper'),
    telemetryThrottleWrapper: document.getElementById('telemetryThrottleWrapper'),
    telemetryThrottleChart: document.getElementById('telemetryThrottleChart'),
    telemetryBrakeWrapper: document.getElementById('telemetryBrakeWrapper'),
    telemetryBrakeChart: document.getElementById('telemetryBrakeChart'),
    telemetryGearWrapper: document.getElementById('telemetryGearWrapper'),
    telemetryGearChart: document.getElementById('telemetryGearChart'),
    telemetryDetailMode: document.getElementById('telemetryDetailMode'),
    telemetryResetZoom: document.getElementById('telemetryResetZoom'),
